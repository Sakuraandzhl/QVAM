...
_C.MODEL.BACKBONE.GLOBAL_HEAD = True
...
_C.MODEL.QVAM = CN()
_C.MODEL.QVAM.IS_RUN = False
_C.MODEL.QVAM.VAD_IS_RUN = False
_C.MODEL.QVAM.NAME = ''
_C.MODEL.QVAM.NUM_HEADS = 8
_C.MODEL.QVAM.ATTN_DROP = 0.
_C.MODEL.QVAM.PROJ_DROP = 0.
_C.MODEL.QVAM.MLP_RATIO = 4.
_C.MODEL.QVAM.MARGIN_ALIGN = 0.1
_C.MODEL.QVAM.MARGIN_DISTINCT = 0.5
_C.MODEL.QVAM.BINARIZE_LAMBDA = 0.1
_C.MODEL.QVAM.NUM_PROMPTS = 64
_C.MODEL.QVAM.VIEW_CLS = False
_C.MODEL.QVAM.VIEW_LAMBDA = 1.
_C.MODEL.QVAM.CVPA_LAMBDA = 1.
_C.MODEL.QVAM.DIVERSITY_LAMBDA = 0.1
_C.MODEL.QVAM.VAD_LAYER = 1
_C.MODEL.QVAM.AFM_LAYER = 1
_C.MODEL.QVAM.MOMENTUM = 0.9
_C.MODEL.QVAM.PROMPTS_VIEW_CLS = False
_C.MODEL.QVAM.PROMPTS_VIEW_CLS_LAMBDA = 0.
# ---------------------------------------------------------------------------- #
# REID LOSSES options
# ---------------------------------------------------------------------------- #
_C.MODEL.LOSSES = CN()
...
_C.MODEL.LOSSES.CL.MARGIN = 1.0
_C.MODEL.LOSSES.CL.ADAPTIVE = True
_C.MODEL.LOSSES.CL.NORMALIZE = True
_C.MODEL.LOSSES.CL.SCALE = 0.5
